...
void ModeloOtimizacao::formularModeloOtimizacao(Dados& a_dados, EntradaSaidaDados a_entradaSaidaDados) {
	...
	try {
		...
		std::cout << "DEFINIU CONSTANTES FORMULA MODELO OTIMIZACAO" << "\n";
		...
		std::cout << "DEFINIU HORIZONTES FORMULA MODELO OTIMIZACAO" << "\n";
		...
		if (true) {
			...
			for (IdEstagio idEstagio = estagio_inicial; idEstagio <= estagio_final; idEstagio++) {
				...
				std::cout << "Aloca defuência dependendo do tempo de viagem d'agua" << "\n";
				if (idEstagio == estagio_inicial) {
			...
			std::cout << "VETOR HORIZONTE ESTUDO" << "\n";
			...
			std::cout << "estagio_inicial: " << int(estagio_inicial) << " estagio_final: " << int(estagio_final) << "\n";
			...
			setVetor(AttVetorModeloOtimizacao_custo_total, SmartEnupla<IdEstagio, double>(estagio_inicial, std::vector<double>(int(estagio_final) - int(estagio_inicial) + 1, 0.0)));
				
			const auto& vetor_custo = getVetor(
				AttVetorModeloOtimizacao_custo_total, 
				IdEstagio(), 
				double()
			);
			for (IdEstagio estagio = vetor_custo.getIteradorInicial();
				 estagio <= vetor_custo.getIteradorFinal();
				 vetor_custo.incrementarIterador(estagio)) {

				std::cout << "Estagio " << int(estagio) 
						  << " -> " << vetor_custo.at(estagio) << std::endl;
			}


			std::cout << "SETOU VETOR CUSTO TOTAL" << "\n";
			...
			setVetor(AttVetorModeloOtimizacao_custo_imediato, SmartEnupla<IdEstagio, double>(estagio_inicial, std::vector<double>(int(estagio_final) - int(estagio_inicial) + 1, 0.0)));
			std::cout << "SETOU VETOR CUSTO IMEDIATO" << "\n";
			...
			setVetor(AttVetorModeloOtimizacao_custo_futuro, SmartEnupla<IdEstagio, double>(estagio_inicial, std::vector<double>(int(estagio_final) - int(estagio_inicial) + 1, 0.0)));
			std::cout << "SETOU VETOR CUSTO FUTURO" << "\n";
			...
			std::cout << "SETOU MATRIZ SOLUCAO PROXY" << "\n";
			...
			std::cout << "SETOU MATRIZ TRATA INVIAB" << "\n";
			setMatriz(AttMatrizModeloOtimizacao_custo_medio, custo_medio);
			std::cout << "SETOU MATRIZ CUSTO MEDIO" << "\n";
			...
			std::cout << "SETOU MATRIZ DURACAO PATAMAR CARGA PERCENTUAL" << "\n";
		} // if (true) {
		...
		for (IdEstagio idEstagio = estagio_inicial; idEstagio <= estagio_final; idEstagio++) {
			...
			//
			// **************************************************************************************************************************
			std::cout << "INICIA CONSTRUCAO FCF LIMITES VARIAVEIS" << "\n";
			...
			for (int i = 0; i < int(listaTipoSubproblemaSolver.size()); i++) {
				...
				std::cout << "VARIÁVEIS ASSOCIADAS AO HORIZONTE DE ESTUDO" << "\n";
				...
				std::cout << "VARIÁVEIS ASSOCIADAS AO HORIZONTE DE OTIMIZAÇÃO" << "\n";
				...
				std::cout << "VARIÁVEIS ASSOCIADAS AO HORIZONTE DO PROCESSO ESTOCASTICO" << "\n";
				...
				std::cout << "RESTRIÇÕES DE CUSTO TOTAL IMEDIADO e FUTURO" << "\n";
				...
				for (Periodo periodo_estudo = horizonte_estudo_estagio.getIteradorInicial(); periodo_estudo <= horizonte_estudo_estagio.getIteradorFinal(); horizonte_estudo_estagio.incrementarIterador(periodo_estudo)) {
					...
					for (IdPatamarCarga idPatamarCarga = IdPatamarCarga_1; idPatamarCarga <= maiorIdPatamarCarga; idPatamarCarga++) {
						...
						std::cout << "RESTRIÇÕES HIDRAULICA ESPECIAL VAZÃO DEFLUENTE " << "\n";
						...
						for (IdHidreletrica idHidreletrica = IdHidreletrica_1; idHidreletrica <= maiorIdHidreletrica; idHidreletrica++) {
							...
							if (idPatamarCarga == IdPatamarCarga_1) {
								...
								std::cout << "CRIA RESTRIÇÕES DE VOLUME UTIL " << "\n";
						...
						std::cout << "CRIA RESTRIÇÃO ELETRICA (RE) " << "\n";
		...
		std::cout << "criarVariaveis_Decisao_e_Estado_e_Restricoes_ZPVOLUME_ACUMULADO_e_ACUMULANDO " << "\n";
